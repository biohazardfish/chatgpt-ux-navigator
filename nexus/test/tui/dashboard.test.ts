...
describe('Dashboard View', () => {
  ...
  it('renders project summary', () => {
      const project: Project = {
          meta: { version: 1, projectId: 'test-p', createdAt: '', lastUpdatedAt: '', status: 'active' },
          projectDoc: { title: 'Test Project', goals: ['Goal 1', 'Goal 2'], constraints: [], nonGoals: [] },
          plan: { status: 'draft', phases: ['Phase 1', 'Phase 2'], notes: [] },
          tasks: [], // Empty tasks
          decisions: [],
          notes: { assumptions: ['Assumption 1'], clarifications: [], lessonsLearned: [], projectNotes: [] }
      };
