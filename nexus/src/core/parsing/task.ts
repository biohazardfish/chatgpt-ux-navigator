...
import {extractSections, parseBulletList, parseSingleLine, requireSection} from './markdown.ts';
...
const VALID_STATUSES: TaskStatus[] = ['pending', 'running', 'blocked', 'completed', 'aborted'];
const VALID_STATUS_SET = new Set<TaskStatus>(VALID_STATUSES);

const VALID_ROLES: Role[] = ['planner', 'implementer', 'reviewer', 'researcher', 'devils-advocate'];
