 ...
 */
function buildTaskContext(projectDoc: ProjectDoc, plan: Plan, notes: Notes): TaskContext {
    return {
 ...
 */
export function prepareExecutableTask(project: Project, taskId: string): ExecutableTask {
    ...
    const context = buildTaskContext(project.projectDoc, project.plan, project.notes);
 ...
 */
export function validateTransition(taskId: string, from: TaskStatus, to: TaskStatus): void {
