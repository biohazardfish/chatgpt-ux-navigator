# Docs 008 - User in the Loop

This document explains how the user remains actively involved in Nexus-driven work.

Nexus is designed to amplify human judgment, not replace it.  
...
Nexus manages execution, but direction comes from the user.
...
Execution resumes only after user approval.
...
- Adding notes or constraints
- Forcing a decision

Manual intervention is always allowed.
...
The goal is to involve the user where their judgment matters most.
...
This balance allows Nexus to operate efficiently without becoming autonomous.
