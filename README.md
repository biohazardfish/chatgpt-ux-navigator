...
- `POST /images/:client_id/activate` enables **Create image** mode in the current chat (activate-only, no prompt submission).

Note: `POST /images/:client_id/activate` is optimistic and returns once the activate command is sent to the connected tab.
