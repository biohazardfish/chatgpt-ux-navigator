...
describe('RunLogger', () => {
	...
	describe('integration', () => {
		it('produces complete run with transcript and judge outputs', async () => {
			...
			await logger.writeJudge(1, {should_stop: false, scores: {A: 8, B: 0}, reason: 'A spoke well'}, '2026-02-08T14:32:20Z');
			...
			await logger.writeJudge(2, {should_stop: true, scores: {A: 8, B: 9}, reason: 'Both spoke well, stopping.'}, '2026-02-08T14:32:30Z');
